                ...
                <React.Fragment>
                  <a
                    ...
                    className={`block text-slate-200 truncate transition duration-150 ${
                      pathname === '/' || pathname.includes('home') ? 'hover:text-slate-200' : 'hover:text-white'
                    }`}
                    onClick={(e) => {
                      e.preventDefault();
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <HomeIcon className={cn("shrink-0 h-6 w-6", pathname.includes("/home")||pathname === '/'?'text-indigo-500':'text-slate-400')}/>
